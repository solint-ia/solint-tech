 ...
 * Cada item funciona como um card expansível in-place.
 * Ao clicar em qualquer card (mesmo no final da lista), ele se expande
 * DIRETAMENTE ALI MESMO, revelando a sequência de automação e impacto.
 */
export function ApplicationsConstellation({
  ...
  return (
    <div className="relative">
      <div className="relative z-1 grid grid-cols-1 gap-4 md:grid-cols-2">
        {applications.map((app, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Conteúdo Expansível In-Place (abre diretamente abaixo deste item) */}
              {isOpen ? (
